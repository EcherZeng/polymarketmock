...
SYSTEM_PROMPT = (
    ...
    "- � **stop_loss_pct [0-1.0]** [high]: 止损比例（基于本金）。"
    "当账户权益相对初始本金亏损超过此比例时，平掉全部持仓。"
    "例如 0.05 表示亏损本金 5% 即止损。预测市场波动小，建议 0.03-0.10\n"
    ...
    "- � **take_profit_pct [0-1.0]** [medium]: 止盈比例（基于本金）。"
    "当账户权益相对初始本金盈利超过此比例时，平掉全部持仓。"
    "与绝对止盈价独立生效\n"
